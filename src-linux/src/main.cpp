...
uint256 hashGenesisBlock("0x00000000eb675e49907db352087e485814394cf9a218a4ac9b2d3835792ff940");
...
const string strMessageMagic = "FREEMASONCOIN Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000eb675e49907db352087e485814394cf9a218a4ac9b2d3835792ff940");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1432130931;
        block.nBits    = 486604799;
        block.nNonce   = 245046167;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FREEMASONCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FREEMASONCOINMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FREEMASONCOINMiner started\n");
    ...
    try { loop {
        ...
        printf("Running FREEMASONCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FREEMASONCOINMiner terminated\n");
        throw;
    }
}
